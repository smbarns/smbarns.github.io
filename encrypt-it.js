...
(function() {
  ...
  function init() {
    ...
    encryptItButton.addEventListener("click", handleButtonClickEncrypt);
    changeFont();
    toUpper();
  ...
  function toUpper(text)  {
    ...
    allCapsCheckbox.addEventListener("change", function(event) {
